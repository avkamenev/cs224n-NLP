...
class ParserModel(Model):
    ...
    def add_prediction_op(self):
        ...
        W = tf.Variable(xavier_initializer((self.config.n_features*self.config.embed_size, self.config.hidden_size)), name='W', dtype=tf.float32)
        U = tf.Variable(xavier_initializer((self.config.hidden_size, self.config.n_classes)), name='U', dtype=tf.float32)
